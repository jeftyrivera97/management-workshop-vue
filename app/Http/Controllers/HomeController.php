...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $egresosMensual = number_format($egresosMensual, 2);
        $egresosMensual= "L. $egresosMensual";
        ...
        $egresosAnual = number_format($egresosAnual, 2);
        $egresosAnual= "L. $egresosAnual";
        ...
        $totalGastosAnual=Gasto::where('fecha', '>=','2024-01-01')->where('fecha', '<=', '2024-12-31')->sum('total');
        $totalComprasAnual=Compra::where('fecha', '>=','2024-01-01')->where('fecha', '<=', '2024-12-31')->sum('total');
        $totalEgresosAnual = $totalGastosAnual +=$comprasAnual;
        ...
        return Inertia::render('Dashboard', compact('meses','ingresosMensual','dataIngresos','dataEgresos','egresosAnual','totalComprasAnual','totalGastosAnual','ingresosAnual','balanceAnual','porcentajeAnual','porcentajeMensual','balance','fecha','mes','ingresos','gastos','compras','planillas','egresos','year'));
    }
