...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="rounded-xl p-4" style="background-color: #1e1b1a; margin-top: 5px;">
            <b><span> {{modulo}} por Proveedor: </span></b>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="data in dataProveedores" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{data.descripcion}}
                            </th>
                            <td class="px-6 py-4">
                                L. {{data.total.toLocaleString()}}
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="rounded-xl p-4" style="background-color: #1e1b1a; margin-top: 5px;">
            <b><span> {{modulo}} por Categoria: </span></b>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                    ...
                    <tbody>
                        <tr v-for="data in dataCategorias" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{data.descripcion}}
                            </th>
                            <td class="px-6 py-4">
